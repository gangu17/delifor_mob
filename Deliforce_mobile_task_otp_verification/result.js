...
module.exports = {
    ...
    sendAdminChangedStatus: (cb) => {
        cb(null, formResponse(common.ADMIN_CHANGED_STATUS, {message: 'Admin has changed the task status already'}));
    },
    //app
    ...
    selectSmsPlan: (cb) => {
        cb(null, formResponse(task.SMS_REQUIRED, {message: 'SMS plan is not selected'}));
    },
